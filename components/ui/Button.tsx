...
const Button: React.FC<ButtonProps> = ({
  ...
  // Custom style for logo variant
  const logoStyle = variant === 'logo' ? { backgroundColor: '#70075a' } : {};
  ...
  return (
    <button
      className={cn(
        ...
        variants[variant],
        sizes[size],
        variant === 'logo' && 'hover:bg-[#8a0a6e] focus:ring-[#70075a]',
        className
      )}
      style={logoStyle}
